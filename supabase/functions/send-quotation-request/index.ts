            ...
            html: `
              ...
              <head>
                ...
                <style>
                  ...
                  .value { color: #555555; }
                  .file-list { list-style: none; padding: 0; margin: 15px 0; }
                  .file-item { background-color: #f8f9fa; padding: 12px 15px; margin: 8px 0; border-radius: 6px; border-left: 3px solid #4caf50; display: flex; justify-content: space-between; align-items: center; }
                  .file-name { font-weight: 600; color: #1a1a2e; }
                  .file-quantity { background-color: #4caf50; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; }
